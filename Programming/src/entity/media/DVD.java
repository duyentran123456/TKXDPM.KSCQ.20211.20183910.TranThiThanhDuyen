...
public class DVD extends Media {
    ...
    public DVD(int id, String title, String category, int price, int quantity, String type, String discType,
            String director, int runtime, String studio, String subtitles, Date releasedDate, String filmType, boolean rushSupport) throws SQLException{
        super(id, title, category, price, quantity, type, rushSupport);
    ...
    public Media getMediaById(int id) throws SQLException {
        ...
        boolean rushSupport = res.getBoolean("rushSupport");
        ...
        return new DVD(id, title, category, price, quantity, type, discType, director, runtime, studio, subtitles, releasedDate, filmType, rushSupport);
